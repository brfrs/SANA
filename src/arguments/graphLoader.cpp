...
// By default, USE_CACHED_FILES is 0 and SANA does not cache files. Change USE_CACHED_FILES at your own risk.
    string g1LockDir = "networks/" + g1Name + "/autogenerated/" + g1Name + ".lock";
    string g2LockDir = "networks/" + g2Name + "/autogenerated/" + g2Name + ".lock";
    struct stat st;
...
// By default, USE_CACHED_FILES is 0 and SANA does not cache files. Change USE_CACHED_FILES at your own risk.
    if (fg1 == "")
    {
        ...
        string bin = "networks/" + g1Name + "/autogenerated/" + g1Name + (args.bools["-nodes-have-types"] ? "_TypedNodes" : "_UntypedNodes")
    ...
    if (fg2 == "")
    {
        ...
        string bin = "networks/" + g2Name + "/autogenerated/" + g2Name + (args.bools["-nodes-have-types"] ? "_TypedNodes" : "_UntypedNodes") 
        + (usingLocks ? "_Locked" : "_Unlocked") + (multi_pairwise ? "_Multi_pairwise" : "_Not_multi_pairwise") + ".bin";
    ...
    if (!updateG1 && !updateG2)
    {
        ...
        t1 = thread(Graph::loadGraphFromBinary, ref(G1), g1Name, lockFile, args.bools["-nodes-have-types"], args.bools["-lock-same-names"]);
        t2 = thread(Graph::loadGraphFromBinary, ref(G2), g2Name, lockFile, args.bools["-nodes-have-types"], args.bools["-lock-same-names"]);
    }
    else {
#endif
        if (p1 == 1 && p2 == 1)
        {
            ...
            {
                t1 = thread(Graph::loadGraphFromPath, fg1, g1Name, ref(G1), args.bools["-nodes-have-types"]);
            ...
            {
                t2 = thread(Graph::loadGraphFromPath, fg2, g2Name, ref(G2), args.bools["-nodes-have-types"]);
